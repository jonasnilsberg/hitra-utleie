      ...
      <div className='mx-auto flex max-w-7xl items-center justify-between'>
        <div className='grid gap-8 md:gap-0 md:grid-cols-2 w-full'>
          <div className='justify-center mt-20'>
            ...
            <div>
              <p className='text-center font-mono px-4'>Hitra Utleie AS tilbyr leie av maskiner og utstyr til profesjonelle aktører i byggebransjen og til privatmarkedet</p>
            </div>
