        ...
        <div className="grid gap-8 md:gap-0 md:grid-cols-2 w-full">
          <div className="justify-center mt-20">
            <div className="flex justify-center">
              <img alt="" src="/Logo.svg" className="h-40 md:h-80 w-auto" />
            </div>
            <div>
              <p className="text-center font-mono px-4">
                Hitra Utleie AS tilbyr leie av maskiner og utstyr til
                profesjonelle aktører i byggebransjen og til privatmarkedet
              </p>
            </div>
